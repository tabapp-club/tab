...
const TrendUpIcon = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 4l-5 5-3-3-3 3" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <path d="M8 4h4v4" stroke="currentColor" strokeWidth="1.5" fill="none"/>
  </svg>
);

const TrendDownIcon = () => (
  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 10l-5-5-3 3-3-3" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <path d="M8 10h4V6" stroke="currentColor" strokeWidth="1.5" fill="none"/>
  </svg>
);
