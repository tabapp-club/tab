      ...
      <div className="bg-white rounded-lg border border-[#e9e9e9] shadow-[-4px_-4px_12px_0px_rgba(0,0,0,0.08),4px_4px_12px_0px_rgba(0,0,0,0.08)] p-4">
        ...
        <div className="flex items-center justify-center gap-2 py-2 mb-2">
          <button
            ...
            className="w-8 h-8 rounded-[25px] border border-[#e9e9e9] flex items-center justify-center hover:bg-gray-50 transition-colors"
          >
                    ...
                    <button
                      ...
                      className={`h-9 w-9 rounded-lg flex items-center justify-center transition-colors ${
                        isRangeStart(date) || isRangeEnd(date)
                          ...
                          : isInRange(date)
                          ? "bg-[#e8e8e8] text-[#2a2a2f]"
                          : isToday(date)
                          ? "bg-[#f2f2f2] text-[#2a2a2f] border border-[#2a2a2f]"
                          : "text-[#2a2a2f] hover:bg-[#f2f2f2]"
                      }`}
                    >
        ...
        <div className="border-t border-[#e9e9e9] pt-3">
          <div className="flex items-center justify-end gap-1.5">
            <button
              onClick={onClose}
              className="h-8 px-2 bg-white border border-[#dce0e5] rounded flex items-center justify-center hover:bg-gray-50 transition-colors"
            >
            ...
            <button
              ...
              className={`h-8 px-2 rounded flex items-center justify-center transition-colors ${
                selectedRange.from && selectedRange.to
                  ? "bg-[#2a2a2f] hover:bg-[#1a1a1f] text-white"
