...
const DataCenterHeader = ({ onImportClick, onAddPatientClick }: DataCenterHeaderProps) => {
  return (
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 min-w-0">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto min-w-0">
          <button
            ...
            className="flex-1 sm:flex-none px-4 h-9 text-white bg-[#9747FF] border border-[#9747FF] rounded font-semibold text-[14px] leading-[1.4] hover:bg-[#6B46E5] focus:ring-[#9747FF]/50  transition-all duration-200 ease-in-out flex items-center justify-center gap-2 whitespace-nowrap"
          >
            <AddIcon />
            <span>Add new patient/client</span>
          </button>
          <button
