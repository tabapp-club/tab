...
import { Plus, History, Settings, Building2, ArrowLeft } from "lucide-react";
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div>
              ...
              <p className="text-[14px] text-[#2A2A2F] font-normal mt-2">
                Manual customer entry for businesses without POS systems
              </p>
            </div>
            <a 
              href="/dashboard" 
              className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded text-sm font-medium transition-all duration-200 flex items-center gap-2 self-start sm:self-auto"
            >
