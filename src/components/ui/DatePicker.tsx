    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <button
          disabled={disabled}
          className={`
            w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-[4px]
            focus:outline-none focus:ring-2 focus:ring-[#9747FF] focus:border-transparent transition-colors
      ...
      <PopoverContent 
        className="w-auto p-0 bg-white border border-gray-200 rounded-[4px] shadow-lg z-[100]" 
        align="start" 
        sideOffset={4}
        side="bottom"
      >
        <DayPicker
          ...
          classNames={{
            ...
            head_row: "flex",
            head_cell: "text-gray-500 rounded-[4px] w-8 font-normal text-[0.8rem]",
            ...
            day_selected: "bg-[#9747FF] text-white hover:bg-[#8636ee] focus:bg-[#9747FF]",
