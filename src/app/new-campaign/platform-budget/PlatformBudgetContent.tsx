  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="bg-white h-12 px-4 py-3 border border-[#e9e9e9] rounded-lg flex items-center justify-between overflow-hidden hover:bg-gray-50 transition-colors w-full text-left focus:outline-none focus:ring-2 focus:ring-[#9747FF]/20 focus:border-[#9747FF]"
      >
              ...
              <div className="lg:hidden space-y-4">
                ...
                <div className={`border rounded-lg p-4 transition-all ${
                  selectedPlatforms.includes('tab') 
                    ...
                    : 'border-[#e9e9e9] bg-white hover:border-[#9747FF]/50'
                }`}>
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-[#9747FF] rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-[12px] font-medium bg-[#9747FF]/10 text-[#9747FF]">Rich Media</span>
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-[12px] font-medium bg-[#9747FF]/10 text-[#9747FF]">Interactive</span>
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-[12px] font-medium bg-[#9747FF]/10 text-[#9747FF]">Analytics</span>
                  </div>
                </div>
              ...
              <div className="hidden lg:block overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-[#e9e9e9]">
                    {/* Tab Platform - Rank 1 */}
                    <tr className="bg-[#9747FF]/5 hover:bg-[#9747FF]/10 transition-colors border-l-4 border-l-[#9747FF]">
            ...
            <div className="p-4 border-b border-[#e9e9e9]">
              ...
              <div className="lg:hidden">
                ...
                <button
                  ...
                  className="w-full h-9 px-6 py-1 rounded font-semibold text-[14px] bg-gradient-to-r from-[#9747FF] to-[#9747FF] text-white hover:from-[#9747FF] hover:to-[#9747FF] hover:shadow-lg  focus:ring-[#9747FF]/50  transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap relative overflow-hidden"
                >
                  ...
                  <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-8 pr-4 py-3 border rounded-lg text-[14px] bg-white focus:outline-none focus:ring-2 focus:ring-[#9747FF]/20 transition-colors ${
                              errors.total ? 'border-red-500' : 'border-[#e9e9e9] focus:border-[#9747FF] hover:border-[#d1d5db]'
                            }`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-8 pr-4 py-3 border rounded-lg text-[14px] bg-white focus:outline-none focus:ring-2 focus:ring-[#9747FF]/20 transition-colors ${
                              errors.daily ? 'border-red-500' : 'border-[#e9e9e9] focus:border-[#9747FF] hover:border-[#d1d5db]'
                            }`}
                            ...
                            <div className="mt-3 space-y-3 bg-white border border-[#e9e9e9] rounded-lg p-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                      <div>
                                        ...
                                        <input
                                          ...
                                          className="w-full px-2 py-1 text-[12px] border border-[#e9e9e9] rounded bg-white focus:outline-none focus:ring-1 focus:ring-[#9747FF]/20 focus:border-[#9747FF] hover:border-[#d1d5db] transition-colors"
                                          placeholder="0"
                                        />
                    </div>
                                      <div>
                              ...
                              <div className="flex gap-2 pt-3 border-t border-[#e9e9e9]">
                                <button
                                  ...
                                  className="text-[12px] text-[#9747FF] hover:text-[#5A3FE6] font-medium px-3 py-1 rounded hover:bg-[#9747FF]/5 transition-colors"
                                >
                                  Equalize All
                                </button>
                                <button
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className="h-9 px-4 py-1 border border-[#e9e9e9] rounded font-medium text-[14px] text-[#9747FF] bg-white hover:bg-[#9747FF]/5 hover:border-[#9747FF]/50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#9747FF]/20 focus:border-[#9747FF]"
                      >
                    ...
                    <div
                      className={`border rounded-lg p-4 sm:p-6 transition-all duration-200 cursor-pointer ${
                        selectedBudgetType === 'conservative'
                          ? 'border-[#9747FF] bg-[#9747FF]/5'
                          : 'border-[#e9e9e9] hover:border-[#9747FF] hover:bg-[#f8f9fa]'
                      }`}
                      ...
                      <div className="block sm:hidden">
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="px-2 py-1 bg-[#9747FF]/10 text-[#9747FF] text-[10px] font-medium rounded-full uppercase tracking-wide">Medium Risk</span>
                          </div>
                          <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                            selectedBudgetType === 'balanced'
                              ? 'border-[#9747FF] bg-[#9747FF]'
                         ...
                         <div className="transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] transform origin-top">
                           ...
                           <div className="space-y-1 ml-2">
                             ...
                             <div className="flex justify-between items-center text-[14px]">
                               ...
                               <span className="font-medium text-[#9747FF]">25%</span>
                  </div>
                             <div className="flex justify-between items-center text-[14px]">
